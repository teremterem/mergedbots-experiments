...
from experiments.mergedbots_copilot.mergedbots_copilot import mergedbots_copilot
...
if __name__ == "__main__":
    MergedBotDiscord(bot=mergedbots_copilot.merged_bot, discord_client=discord_client)
