...
from experiments.mergedbots_copilot.lc_agent_experiments import lc_agent_experiments
...
if __name__ == "__main__":
    MergedBotDiscord(bot=lc_agent_experiments.bot, discord_client=discord_client)
